      ...
      <div class="w-full pt-0 p-8">
        <div class="mx-auto md:p-2 md:w-full">
          <div class="bg-white shadow-md rounded px-8 pt-4 mb-6">
            ...
            <h1 class="font-semibold text-lg  font-primary pb-4 pt-2">
              Interpretation and Definitions
            </h1>
            <h2 class="font-medium text-lg  font-primary pb-2 ">
              Interpretation
            </h2>
            <p class="font-normal text-base  font-primary pb-2">
            ...
            <h2 class="font-medium text-lg  font-primary pb-2 ">Definitions</h2>
            <p class="font-normal text-base  font-primary pb-2">
            ...
            <ul class="font-normal text-base  font-primary list-disc pb-4 pl-8">
              <li>
                <p>
                  <strong class="font-semibold text-base  font-primary">
                    Account
                  </strong>{" "}
              ...
              <li>
                <p>
                  ...
                  Agreement) refers to regimefit-fitness-plans.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  ...
                  refers to regimefit-fitness-plans, accessible from{" "}
                  <a
                    href="https://fitnessplans.regimefit.com"
                    rel="external nofollow noopener"
                    target="_blank"
                  >
                    https://fitnessplans.regimefit.com
                  </a>
                </p>
              </li>
              <li>
            ...
            <h2 class="font-medium text-lg  font-primary pb-0 ">
              Types of Data Collected
            </h2>
            <h3 class="font-medium text-lg  font-primary pb-2 ">
              Personal Data
            </h3>
            <p class="font-normal text-base  font-primary pb-2">
            ...
            <h3 class="font-medium text-lg  font-primary pb-2 ">Usage Data</h3>
            <p class="font-normal text-base  font-primary pb-2">
