export function TermsAndConditionsTable() {
  return (
    <div class="mx-auto container flex items-center" id="nav">
      <div class="w-full pt-0 p-8">
        <div class="mx-auto md:p-2 md:w-full">
          <div class="bg-white shadow-md rounded px-8 pt-4 mb-6">
          
            <p class="font-semibold text-lg  font-primary pb-4">Welcome to regimefit-fitness-plans!</p>

            <p class="font-normal text-base  font-primary pb-2">
              These terms and conditions outline the rules and regulations for
              the use of regimefit.com's Website, located at
              https://fitness-plans.regimefit.com
            </p>

            <p class="font-normal text-base  font-primary pb-2">
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use regimefit-fitness-plans if you
              do not agree to take all of the terms and conditions stated on
              this page.
            </p>

            <p class="font-normal text-base  font-primary pb-4">
            ...
            <h3 class="font-semibold text-base  font-primary pb-4">
                Cookies
            </h3>

            <p class="font-normal text-base  font-primary pb-2">
              We employ the use of cookies. By accessing
              regimefit-fitness-plans, you agreed to use cookies in agreement
              with the regimefit.com's Privacy Policy.{" "}
            </p>
            ...
            <p class="font-normal text-base  font-primary pb-4">
              Unless otherwise stated, regimefit.com and/or its licensors own
              the intellectual property rights for all material on
              regimefit-fitness-plans. All intellectual property rights are
              reserved. You may access this from regimefit-fitness-plans for
              your own personal use subjected to restrictions set in these terms
              and conditions.
            </p>

            <p class="font-normal text-base  font-primary pb-4">You must not:</p>
            <ul  class="font-normal text-base  font-primary list-disc pb-4 pl-8">
              <li>Republish material from regimefit-fitness-plans</li>
              <li>
                Sell, rent or sub-license material from regimefit-fitness-plans
              </li>
              <li>
                Reproduce, duplicate or copy material from
                regimefit-fitness-plans
              </li>
              <li>Redistribute content from regimefit-fitness-plans</li>
            </ul>
            ...
            <p  class="font-normal text-base  font-primary pb-2">
              ...
              regimefit.com does not filter, edit, publish or review Comments
              prior to their presence on the website. Comments do not reflect
              the views and opinions of regimefit.com,its agents and/or
              ...
              applicable laws, regimefit.com shall not be liable for the
            ...
            <p  class="font-normal text-base  font-primary pb-4">
              regimefit.com reserves the right to monitor all Comments and to
              remove any Comments which can be considered inappropriate,
              offensive or causes breach of these Terms and Conditions.
            </p>

            <p  class=" font-normal text-base  font-primary pb-4">You warrant and represent that:</p>
            ...
            <p  class="font-normal text-base  font-primary pb-4">
              You hereby grant regimefit.com a non-exclusive license to use,
            ...
            <p  class="font-normal text-base  font-primary pb-2">
              ...
              regimefit.com; and (d) the link is in the context of general
            ...
            <p  class="font-normal text-base  font-primary pb-2">
              ...
              by sending an e-mail to regimefit.com. Please include your name,
            ...
            <p  class="font-normal text-base  font-primary pb-4">
              No use of regimefit.com's logo or other artwork will be allowed
